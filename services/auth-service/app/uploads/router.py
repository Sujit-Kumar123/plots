...
async def create_upload(
    ...
    return ResponseHandler.ok(data=FileUploadResponse.model_validate(file_upload).model_dump())
...
async def get_upload(
    ...
    return ResponseHandler.ok(data=response.model_dump())
...
async def remove_upload(
    ...
    return ResponseHandler.ok("File deleted")
