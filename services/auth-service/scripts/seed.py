...
Usage (from auth-service directory):
    uv run python scripts/seed.py

Usage (via docker compose):
    docker compose -f docker-compose.dev.yml exec auth-service uv run python scripts/seed.py
"""
...
ROLES = [
    {
        ...
        "description": "Full system access via wildcard permission",
    },
    {
        "name": "Admin",
        "short_name": "admin",
        "description": "Administrative access to users, roles, permissions, and audit",
    },
    {
        "name": "Member",
        "short_name": "member",
        "description": "Standard user access — profile, plots, chat, and uploads",
    },
]


# ── Permissions ───────────────────────────────────────────────────────────────
# Must stay in sync with app/common/permissions/codes.py
...
PERMISSIONS = [
    ...
    # Plot sheets
    {"name": "Sheets Read",           "code": "sheets:read",          "description": "View plot sheets"},
    {"name": "Sheets Write",          "code": "sheets:write",         "description": "Create and update plot sheets"},
    {"name": "Sheets Delete",         "code": "sheets:delete",        "description": "Delete plot sheets"},
    # Chat
    {"name": "Chat Read",             "code": "chat:read",            "description": "View chat messages and sessions"},
    {"name": "Chat Write",            "code": "chat:write",           "description": "Send chat messages"},
    {"name": "Chat Delete",           "code": "chat:delete",          "description": "Delete chat messages"},
]
